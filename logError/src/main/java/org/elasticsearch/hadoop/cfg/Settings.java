...
public abstract class Settings {
    ...
    public String getShardPreference() {
        return getProperty(ES_READ_SHARD_PREFERENCE, ES_READ_SHARD_PREFERENCE_DEFAULT);
    }
    ...
    public String getResourceWrite() {
        return getProperty(ES_RESOURCE_WRITE, getResource())
                .replaceAll("\\*", new SimpleDateFormat("yyyy-MM-dd").format(Calendar.getInstance().getTime()));
    }
